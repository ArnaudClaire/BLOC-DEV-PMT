-- Jeu de données de démonstration pour PostgreSQL
-- Ce script complète la structure définie dans
-- `database/migrations/V1__initial_schema_postgresql.sql`.
-- Il est idempotent et sert de livrable SQL pour les démonstrations
